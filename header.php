...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo("template_url"); ?>/assets/css/main.min.css?2024-kis">
  ...
  <div class="container">
    <div class="row">
      <div class="header-logo col-md-6 col-xs-12">
        <a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo("template_url"); ?>/assets/images/oyk2024kis-logo.png?V8" width="429" alt=""></a>
      </div>
      <div class="header-logo-list col-md-6 col-xs-12">
        <div class="pull-right pull-right-xs">
          ...
          <a href="http://www.anadolu.edu.tr/" target="_blank">
            <img src="<?php bloginfo("template_url"); ?>/assets/images/anadolu.png?v1"  height="100" width="100" alt="">
          </a>
        </div>
      </div>
    </div>
